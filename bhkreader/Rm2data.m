...
- (void)sendsetmac:(NSString *)mac data:(NSString *)data{
    BLSDKTool *sdktool = [BLSDKTool responseDatatoapiid:134 command:@"rm2_send" mac:mac data:@"2600500012992143613101410133614101410131114101411133514341410133614351435143514351410141014111310141014101311141113361435143414351534133714351451c1294814ccb"];
        if (sdktool.code == 0) {
